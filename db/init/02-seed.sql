...
-- Admin user (password: "DevPassword123!" — bcrypt hash, cost 12)
...
VALUES
  ('p0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'Alice & Partner — Wedding',   'booked',   'Wedding',   CURRENT_DATE + INTERVAL '30 days', 'Northampton', 1800.00, 450.00, 0.00, now()),
  ('p0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', 'c0000000-0000-0000-0000-000000000002', 'Bob — Portrait Session',      'lead',     'Portrait',  CURRENT_DATE + INTERVAL '10 days', 'Studio',      150.00,   0.00, 0.00, now()),
  ('p0000000-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000003', 'Carol — Maternity Shoot',     'delivered','Maternity', CURRENT_DATE - INTERVAL '5 days',  'Outdoor',     300.00, 300.00, 0.00, now());
...
VALUES
  ('i0000000-0000-0000-0000-000000000001', 'INV-DEV-0001', 'b0000000-0000-0000-0000-000000000001', 'c0000000-0000-0000-0000-000000000001', 'Alice Anderson', 'alice@dev.local', '[{"description":"Wedding deposit","quantity":1,"total":450.00}]', 450.00, 450.00, 450.00, 'paid', CURRENT_DATE + INTERVAL '7 days', now()),
  ('i0000000-0000-0000-0000-000000000002', 'INV-DEV-0002', 'b0000000-0000-0000-0000-000000000003', 'c0000000-0000-0000-0000-000000000003', 'Carol Clarke',   'carol@dev.local', '[{"description":"Maternity session — full payment","quantity":1,"total":300.00}]', 300.00, 300.00, 300.00, 'paid', CURRENT_DATE - INTERVAL '10 days', now());

-- Payments
INSERT INTO payments (id, invoice_id, booking_id, amount, currency, method, status, provider_ref, created_at)
VALUES
  ('y0000000-0000-0000-0000-000000000001', 'i0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 450.00, 'GBP', 'bank_transfer', 'completed', 'DEV-REF-001', now()),
  ('y0000000-0000-0000-0000-000000000002', 'i0000000-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000003', 300.00, 'GBP', 'bank_transfer', 'completed', 'DEV-REF-002', now());

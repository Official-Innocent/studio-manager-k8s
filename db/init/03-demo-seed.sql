...
VALUES
  ...
  ('d1000000-0000-0000-0000-000000000003', 'b1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000003', 'Priya — Maternity Shoot',              'project_covered','Maternity Session',  CURRENT_DATE + INTERVAL '14 days',  'Studio',                     'Deposit paid, scheduled for next 2 weeks.', 300.00,   100.00,  100.00,    0.00, CURRENT_DATE + INTERVAL '28 days',  CURRENT_DATE + INTERVAL '7 days',  false, NULL, now() - INTERVAL '20 days'),
  ('d1000000-0000-0000-0000-000000000004', 'b1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000004', 'Liam — Family Session',               'post_production','Family Portraits',  CURRENT_DATE - INTERVAL '5 days',   'Sywell Country Park',        'Shoot complete, editing in progress.', 420.00,   420.00,    0.00,  420.00, CURRENT_DATE + INTERVAL '9 days',   NULL, false, NULL, now() - INTERVAL '35 days'),
